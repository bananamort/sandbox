...
Lua integration layer for this patched Lua 5.1 VM: the C++ umbrella header with RAII helpers, the userdata bridging templates every Lua-facing class builds on, and ten decoy-stub units (990 inert `LuaStubGen<N>` callables total) used as anti-tamper filler.
...
- [luaStubs0.md](luaStubs0.md) … [luaStubs9.md](luaStubs9.md) — decoy stub units, 99 `LuaStubGen<N>` globals each.
