# App/include/lua/luaStubs3.h

## Purpose

Fourth decoy-stub unit: 100 global `RBX::Lua::LuaStubGen<N> stubN;` definitions (stub290, stub734, ... stub758); same anti-tamper filler pattern as the other luaStubs files.
