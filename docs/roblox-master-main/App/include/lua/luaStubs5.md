# App/include/lua/luaStubs5.h

## Purpose

Sixth decoy-stub unit: 100 global `RBX::Lua::LuaStubGen<N> stubN;` definitions (stub641, stub200, ... stub521); same anti-tamper filler pattern as the other luaStubs files.
