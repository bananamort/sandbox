...
- Event contract (protected virtuals): onMouseDown/onRightMouseDown/onKeyDown/onKeyUp/onMouseUp/onRightMouseUp/onMouseWheelForward/onMouseWheelBackward return `shared_ptr<MouseCommand>` (default self; Up default releases capture and returns null — ends chain; Peek variants default null); void hooks onMouseIdle ("called on heartbeat regardless of capture"), onMouseHover, onMouseMove, onMouseDelta.
