...
- Windows/ATL: `<windows.h>`, `<atlsync.h>`, `<atlwin.h>`, `<atlbase.h>`, `<Sensapi.h>` (network-connectivity sensing), `<Shellapi.h>`, `<Softpub.h>`+`<wintrust.h>`+`<wincrypt.h>` (WinVerifyTrust / crypto — used by Crypt.cpp's Authenticode verification), `<comutil.h>` (`_bstr_t`, `_variant_t`).
